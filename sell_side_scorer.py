...
def score_ticker(ticker, sell_sigs, market, sector_states, framework_score=None):
    ...
    # dist arrives from compute_sell_signals ALREADY in percentage points
    # (that function does round(dist*100, 1)), e.g. -3.9 means 3.9% below high.
    # Do NOT multiply by 100 again.
    dist = sell_sigs.get("dist")  # e.g. -3.9 = 3.9% below 252d high
